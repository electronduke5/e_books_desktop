...
abstract class $QuoteCopyWith<$Res> {
  ...
  @useResult
  $Res call({int id, User user, String text});
...
class _$_Quote implements _Quote {
  const _$_Quote({required this.id, required this.user, required this.text});
  ...
  @override
  String toString() {
    return 'Quote(id: $id, user: $user, text: $text)';
  }
...
abstract class _Quote implements Quote {
  const factory _Quote(
      ...
      required final String text}) = _$_Quote;
