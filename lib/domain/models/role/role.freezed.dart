...
class _$_Role implements _Role {
  const _$_Role({required this.id, required this.roleName});
...
abstract class _Role implements Role {
  const factory _Role({required final int id, required final String roleName}) =
      _$_Role;
